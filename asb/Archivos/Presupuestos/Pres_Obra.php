...
$Precios = isset($_GET['Precios']) ? base64_decode($_GET['Precios']) : '';
...
while ($rst = $sql->fetch_object()) {
    ...
    while ($rst2 = $sql2->fetch_object()) {
        ...
        $porcentaje = $presData['Imp_CD'] == 0 || $presData['Imp_CD'] == "" ? 0 : $importe / $presData['Imp_CD'] * 100;

        $tot += $porcentaje == 0 ? 0 : $total * $porcentaje / 100;
    }
...
<page backimg="" backtop="9mm" backbottom="30mm" backleft="0mm" backright="0mm">
    <page_header>
        <table align="right">
            <tr>
                        ...
                        if ($rst4->Tipo ==  'I') {
                            ...
                            if ($Precios == "N") {
                                $tr .= "<tr class='text-center'>
                                        <td class='W60'>$rst4->Cve</td>
                                        <td style=' width: 250px; font-size: smaller; text-align: justify'>$rst4->Descripcion</td>
                                        <td class='W60'>$rst4->UM</td>
                                        <td class='W60'>$rst4->Cant</td>
                                ...
                                $tr .= "<tr class='text-center'>
                                        ...
                                        <td class='W60'>$rst4->UM</td>
                                        <td class='W60'>$rst4->Cant</td>
                                        <td class='W60 text-right'>$" . number_format($Precio, 2) . "</td>
                                        <td class='W60 text-right'>$" . number_format($totalCons, 2) . "</td>
                                        <td class='W60 text-right'>" . number_format($porcentaje, 2) . "%</td>
                                    </tr>";
                            }
                        }
                    }
